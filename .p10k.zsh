...
() {
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/Work/webapp-alpha(|/*)'    STAFFAPP      ''
    '~/Work/client-app(|/*)'      CLIENTAPP     ''
    '~(|/*)'                      HOME          ''
  )
  #   Styling for STAFFAPP
  typeset -g POWERLEVEL9K_DIR_STAFFAPP_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_STAFFAPP_BACKGROUND=4
  typeset -g POWERLEVEL9K_DIR_STAFFAPP_FOREGROUND=239
  typeset -g POWERLEVEL9K_DIR_STAFFAPP_SHORTENED_FOREGROUND=239
  typeset -g POWERLEVEL9K_DIR_STAFFAPP_ANCHOR_FOREGROUND=239
  #   Styling for CLIENTAPP
  typeset -g POWERLEVEL9K_DIR_CLIENTAPP_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_CLIENTAPP_BACKGROUND=4
  typeset -g POWERLEVEL9K_DIR_CLIENTAPP_FOREGROUND=239
  typeset -g POWERLEVEL9K_DIR_CLIENTAPP_SHORTENED_FOREGROUND=239
  typeset -g POWERLEVEL9K_DIR_CLIENTAPP_ANCHOR_FOREGROUND=239
  #   Styling for HOME
  # typeset -g POWERLEVEL9K_DIR_HOME_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_HOME_BACKGROUND=0
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=15
  # typeset -g POWERLEVEL9K_DIR_HOME_SHORTENED_FOREGROUND=239
  # typeset -g POWERLEVEL9K_DIR_HOME_ANCHOR_FOREGROUND=239
  #   # Styling for WORK.
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=6
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_BACKGROUND=5
  # Custom icon.
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION=' 撚'
